package com.samtech.HelloWorld.Logging;
...
public class HelloWorldLogging {
	...
	private HelloWorldLogging(Class<?> clazz) {
		logger = LoggerFactory.getLogger(clazz);
	}
	
	public static HelloWorldLogging getLogger(Class<?> clazz) {
		return new HelloWorldLogging(clazz);
	}
